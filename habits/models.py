...
class Habit(models.Model):
    ...
    action = models.CharField(
        max_length=500, verbose_name="Действие", help_text="Действие, которое представляет собой привычка"
    )
    ...
    is_public = models.BooleanField(
        default=False, verbose_name="Признак публичности", help_text="Привычки можно публиковать в общий доступ"
    )
...
class HabitLog(models.Model):
    ...
    habit = ForeignKey(Habit, on_delete=models.CASCADE, related_name="logs", verbose_name="Привычка")
